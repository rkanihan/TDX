<script lang="ts">
	...
	import TdxIcon from '$lib/TDXIcon.svelte';
	import GitHubIcon from '$lib/GitHubIcon.svelte';
	import ApiDocsIcon from '$lib/DocsIcon.svelte';
...
<div class="dashboard-container">
	...
	<header class="hero">
		...
		<div class="header-actions">
			<a
				href="https://github.com/rkanihan/TDX"
				target="_blank"
			...
			<a
				href="https://service.purdue.edu/TDNext/Home/Desktop/Default.aspx"
				target="_blank"
				rel="noopener noreferrer"
				class="icon-link"
				aria-label="TDX Ticketing App"
			>
				<TdxIcon />
			</a>

			<a
				href="https://service.purdue.edu/TDWebApi/"
				target="_blank"
				rel="noopener noreferrer"
				class="icon-link"
				aria-label="TDX API Docs"
			>
				<ApiDocsIcon />
			</a>
		</div>
...
<style>
	...
	.panel {
		...
		box-shadow:
			...
			inset 0 2px 4px rgba(80, 80, 255, 0.3);
	}

	.p1 {
		top: -25vh;
		left: -60vw;
		animation: pShift 12s infinite alternate ease-in-out;
	}
	.p2 {
		top: -2vh;
		left: -40vw;
		animation: pShift 16s infinite alternate-reverse ease-in-out;
	}
	.p3 {
		top: 22vh;
		left: -70vw;
		animation: pShift 14s infinite alternate ease-in-out;
	}
	.p4 {
		top: 48vh;
		left: -50vw;
		animation: pShift 18s infinite alternate-reverse ease-in-out;
	}
	.p5 {
		top: 75vh;
		left: -80vw;
		animation: pShift 10s infinite alternate ease-in-out;
	}
	.p6 {
		top: 105vh;
		left: -45vw;
		animation: pShift 15s infinite alternate-reverse ease-in-out;
	}
	...
	@keyframes pShift {
		...
		100% {
			transform: rotate(-30deg) translate(-8%, -80px);
		}
	}
